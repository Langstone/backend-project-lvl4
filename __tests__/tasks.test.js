...
describe('test statuses CRUD', () => {
  ...
  it('create', async () => {
    ...
    const expectedTask = _.omit(params, 'labelId');
    ...
    const expectedLabels = await models.label.query().findByIds(params.labelId);
  ...
  it('show', async () => {
    ...
    const response = await app.inject({
      method: 'GET',
      url: app.reverse('tasks', { id: currentTask.id }),
      cookies,
    });
  ...
  it('delete', async () => {
    ...
    const response = await app.inject({
      method: 'DELETE',
      url: app.reverse('deleteTask', { id: currentTask.id }),
      cookies,
    });
